...
final class ThirdPartyQuickEntryClient
{
    ...
    {
        $stats=$this->stats($accountKey);$stats['login_count']=(int)($stats['login_count']??0)+1;$stats['last_login_at']=date('Y-m-d H:i:s');$stats['last_login_duration_ms']=(int)round((microtime(true)-$started)*1000);$this->saveStats($accountKey,$stats);
    }
