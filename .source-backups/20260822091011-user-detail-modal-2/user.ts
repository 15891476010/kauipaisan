...
export type BetRecord = { id: number; issue_no: string; source_text?: string; formatted_text?: string; bet_count: number; amount: string; win_amount: string; status: string; sealed: number; placed_at: string; lottery?: string; open_time?: string | null; can_refund?: boolean };
...
export type QuickPreview = { lines: QuickEntryLine[]; count: number; amount: string; formatted_text: string };
