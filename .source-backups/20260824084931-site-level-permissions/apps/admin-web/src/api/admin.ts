...
export type SiteAgentPermissions = { site: { id: number; name: string }; tree: AgentPermissionNode[]; permissions: string[] }
...
export const saveSiteAgentPermissions = (siteId: number, permissions: string[]) => http.put<never, Envelope<{ permissions: string[] }>>(`/admin/sites/${siteId}/agent-permissions`, { permissions })
