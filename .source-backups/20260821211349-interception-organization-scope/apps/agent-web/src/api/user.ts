...
export type AgentSettingProfile = { username: string; display_name: string; remark: string; share_limit: string; follow_share: number; total_credit: string; allocated_credit: string; available_credit: string };
...
export type InterceptionPlateItem = { odds_id: number; name: string; odds: string; limit: string; used: string; remaining: string; numbers: Array<{ number: string; used: string }> };
