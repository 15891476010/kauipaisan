...
final class AgentLedger
{
    ...
    public function issues(Request $request): \think\response\Json
    {
        ...
        $rows=Db::name('lottery_histories')->where('lottery_id',(int)$lottery['id'])->field('code AS issue_no,draw_day AS date')->order('draw_day desc')->order('code desc')->select()->toArray();
