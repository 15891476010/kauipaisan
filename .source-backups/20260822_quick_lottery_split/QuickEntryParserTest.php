...
if (($shortDirect[0]['status'] ?? null) !== 'success' || ($shortDirect[0]['count'] ?? 0) !== 2 || ($shortDirect[0]['amount'] ?? null) !== '40.00') {
...
if (($longDirect[0]['status'] ?? null) !== 'success' || ($longDirect[0]['count'] ?? 0) !== 1000 || ($longDirect[0]['amount'] ?? null) !== '20000.00') {
