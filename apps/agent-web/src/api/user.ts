...
export type AgentReportMetrics = { bet_count: number; amount: string; win_amount: string; water: string; member_profit: string; share_amount: string; share_profit: string; offline_water: string; agent_water: string; agent_profit: string; platform_amount: string; platform_profit: string; levels?: Record<string, { amount: string; water: string; profit: string; share_amount: string; share_profit: string }> };
