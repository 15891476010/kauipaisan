...
export const getAgentReport = (params: Record<string, unknown>) => request.get<ApiEnvelope<{ summary: AgentReportMetrics; list: AgentReportMemberRow[] }>>('/agent/reports', { params });
