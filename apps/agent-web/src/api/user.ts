...
export type AgentReportMetrics = { bet_count: number; amount: string; win_amount: string; water: string; member_profit: string; viewer_amount: string; share_amount: string; share_profit: string; offline_water: string; agent_water: string; agent_profit: string; platform_amount: string; platform_profit: string; levels?: Record<string, { amount: string; water: string; profit: string; share_amount: string; share_profit: string }> };
...
export const getAgentReport = (params: Record<string, unknown>) => request.get<ApiEnvelope<AgentReportData>>('/agent/reports', { params });
export const getAgentMonthlyReport = (params: Record<string, unknown>) => request.get<ApiEnvelope<AgentMonthlyReportData>>('/agent/reports/monthly', { params });
