...
export const copyLotteryOdds = (id: number, source_lottery_id: number, replace = false) => http.post<never, Envelope<null>>(`/admin/lotteries/${id}/copy-odds`, { source_lottery_id, replace: replace ? 1 : 0 })
