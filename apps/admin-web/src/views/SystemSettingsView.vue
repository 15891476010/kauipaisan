...
<template>
  <div class="system-page" v-loading="loading">
    ...
    <el-card shadow="never"><el-tabs>
      ...
      <el-tab-pane label="密码安全"><el-form label-position="top" @submit.prevent="saveSecurity"><el-form-item label="常见弱密码"><el-input v-model="weakPasswordText" type="textarea" :rows="12" maxlength="13000" show-word-limit placeholder="每行填写一个弱密码"/><div class="tip">每行填写一个，也支持逗号分隔。保存后立即适用于 SaaS、股东、总监、总代理、代理、子账号和用户端的所有新建及修改密码操作。</div></el-form-item><div class="actions"><el-button type="primary" :loading="savingSecurity" @click="saveSecurity">保存密码安全配置</el-button></div></el-form></el-tab-pane>
    </el-tabs></el-card>
  </div>
</template>
